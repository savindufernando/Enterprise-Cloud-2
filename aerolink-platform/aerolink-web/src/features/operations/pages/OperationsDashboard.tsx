        ...
        <div className="space-y-8 animate-fade-in pb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="col-span-1 space-y-6">
                    ...
                    <div className="glass-panel p-6 rounded-xl border border-slate-800">
                        <h2 className="text-sm font-bold text-slate-200 flex items-center mb-4 border-b border-slate-800 pb-3">
                            <Radio className="w-4.5 h-4.5 mr-2 text-cyan-400" />
                        ...
                        <form onSubmit={handleUpdatePrice} className="space-y-4 font-mono text-xs">
                            <div>
                                <div className="flex justify-between items-center text-slate-400 mb-2">
                                    ...
                                    <span className="text-cyan-400 font-bold">${baseRate} USD</span>
                                </div>
                                <input 
                                    type="range" 
                                    min="100" 
                            ...
                            <button type="submit" disabled={pricingLoading} className="w-full bg-cyan-600 hover:bg-cyan-500 text-white font-bold text-xs py-2 rounded-lg flex items-center justify-center space-x-1.5 transition-all cursor-pointer uppercase tracking-wider">
                ...
                {/* scrolling Kafka terminal firehose */}
                <div className="col-span-1 lg:col-span-2">
                    <div className="glass-panel rounded-xl border border-slate-800 flex flex-col h-[600px] relative overflow-hidden bg-[#0d1320]/60">
